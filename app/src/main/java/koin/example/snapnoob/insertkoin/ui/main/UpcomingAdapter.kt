...
class UpcomingAdapter constructor(private var dataItemList: MutableList<MovieData>) : BaseAppAdapter() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder =
            UpcomingViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.list_movie_layout, parent, false))
    ...
    fun addItems(movieData: List<MovieData>){
        movieData.let {
    ...
    inner class UpcomingViewHolder(itemView: View) : BaseViewHolder(itemView) {
        override fun clear() {
